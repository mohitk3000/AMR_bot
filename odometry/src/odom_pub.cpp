...
const double TICKS_PER_METER = 3120; // Calculted
...
void update_odom() {
  ...
  double cycleDistance = (distR + distL) / 2;
  double cycleAngle = asin((distR-distL)/WHEEL_BASE);
  distR=0;
  distL=0;
